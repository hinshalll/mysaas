...
import { 
  Terminal, Copy, RefreshCw, Check, Loader, Server, Code, 
  Zap, ShieldCheck, Eye, EyeOff, Activity, ChevronLeft, ArrowRight,
  Database, AlertTriangle, FileCode, Clock, Lock, Globe, Sparkles,
  Image as ImageIcon, FileText, ArrowUpRight
} from 'lucide-react';
...
export default function DeveloperDashboard() {
  ...
  const [isAnonUser, setIsAnonUser] = useState(true);
    ...
    async function initAuth() {
      ...
      try {
        ...
        if (session?.user) {
          ...
          if (profile) {
            setUserPlan((profile.tier as any) || 'free');
  ...
  }, [fetchLogs, fetchUsageCount]);

  const [activeConsoleTab, setActiveConsoleTab] = useState<'metrics' | 'playground'>('metrics');
  ...
  if (isCheckingSession) {
    return (
      <div style={{ minHeight: '100vh', background: 'oklch(0.10 0.005 250)', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', color: 'white' }}>
        ...
        <span style={{ marginTop: 12, fontSize: 14, fontFamily: 'monospace' }}>Verifying developer credentials...</span>
      </div>
    );
  }
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        backgroundImage: 'radial-gradient(oklch(0.68 0.18 265 / 0.06) 1px, transparent 1px)',
        backgroundSize: '24px 24px',
        pointerEvents: 'none',
        zIndex: 0,
      }} />

      <div style={{ maxWidth: 1100, margin: '0 auto', position: 'relative', zIndex: 1, display: 'flex', flexDirection: 'column', gap: 36 }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, fontSize: 13, fontFamily: 'monospace', color: 'oklch(0.68 0.18 265)' }}>
            <Link href="/api" style={{ color: 'inherit', textDecoration: 'none' }}>API DIRECTORY</Link>
            <span style={{ opacity: 0.4 }}>/</span>
            <span style={{ color: 'white' }}>DEVELOPER DASHBOARD</span>
          </div>
        ...
        <div>
          <span style={{
            ...
            <Activity size={11} /> Developer Console
          </span>
        ...
        {isAnonUser && (
          <div style={{
            ...
            <AlertTriangle size={20} style={{ color: 'oklch(0.72 0.18 25)', flexShrink: 0 }} />
        ...
        <div style={{ display: 'flex', gap: 12, borderBottom: '1px solid oklch(0.20 0.008 250)', paddingBottom: 12, flexWrap: 'wrap' }}>
          {[
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 28 }}>
                ...
                <div style={{
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 8, borderBottom: '1px solid oklch(0.20 0.008 250)', paddingBottom: 12 }}>
                    <Sparkles size={16} style={{ color: 'oklch(0.68 0.18 265)' }} />
            ...
            {playgroundSubTab === 'json' ? (
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(360px, 1fr))', gap: 28 }} className="fade-in">
                ...
                <div style={{ background: 'oklch(0.14 0.006 250)', border: '1px solid oklch(0.20 0.008 250)', borderRadius: 16, padding: 24, display: 'flex', flexDirection: 'column', gap: 20 }}>
                  ...
                  >
                    {sandboxLoading ? <Loader size={14} className="spin" /> : <Zap size={14} />}
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(360px, 1fr))', gap: 28 }} className="fade-in">
                ...
                <div style={{ background: 'oklch(0.14 0.006 250)', border: '1px solid oklch(0.20 0.008 250)', borderRadius: 16, padding: 24, display: 'flex', flexDirection: 'column', gap: 20 }}>
                  ...
                  >
                    {heicSandboxLoading ? <Loader size={14} className="spin" /> : <Zap size={14} />}
